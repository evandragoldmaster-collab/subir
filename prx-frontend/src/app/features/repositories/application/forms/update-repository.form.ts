...
interface BuildUpdateRepositoryFormFieldsOptions {
...
export function buildUpdateRepositoryFormFields(
  options: BuildUpdateRepositoryFormFieldsOptions,
): FormlyFieldConfig[] {
  return [
    {
      ...
      fieldGroup: [
        ...
        },
        {
          ...
          props: {
            ...
            required: true,
            readonly: !options.canEditCriticalFields,
            minLength: 2,
            maxLength: 100,
            pKeyFilter: /^(?!.*--)[A-Za-z0-9-]+$/,
            forceLowercase: true,
            trim: true,
            helperText: options.canEditCriticalFields
              ? 'Sin espacios. Puedes usar letras, números y guiones (-).'
              : 'Solo el propietario puede modificar el nombre del repositorio.',
          },
        },
        {
          key: 'description',
        ...
        },
        {
          ...
          props: {
            ...
            helperText: options.canEditCriticalFields
              ? undefined
              : 'Solo el propietario puede modificar la visibilidad del repositorio.',
            options: [
              {
                label: 'Público',
